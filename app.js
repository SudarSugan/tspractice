...
if (typeof userInput == "string") {
    userName = userInput;
} // instread of useing any if use the unknow u have to declare the if condition then only it will clear the error in the line if u remove if condition u can c the error what it is.
